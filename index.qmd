...
par_quarterly <- apply.quarterly(par, mean)
par_quarterly <- as.zoo(par_quarterly)
par_df <- data.frame(date = time(par_quarterly), value = coredata(par_quarterly))
#par_df <- data.frame(date = index(par_quarterly), value = coredata(par_quarterly)) # Error: par is not tsibble
...
cashrate_quarterly <- as.zoo(cashrate_quarterly)
cashrate_quarterly_df <- data.frame(date = time(cashrate_quarterly), value = coredata(cashrate_quarterly))
#cashrate_quarterly_df <- data.frame(date = index(cashrate_quarterly), value = coredata(cashrate_quarterly))  # Error: cashrate_quarterly_df is not tsibble
...
hrs_full <- as.zoo(hrs_full)
hrs_full_df <- data.frame(date = time(hrs_full), value = coredata(hrs_full))
#hrs_full_df <- data.frame(date = index(hrs_full), value = coredata(hrs_full))   # Error: hrs_full_df is not tsibble
...
hrs_part <- as.zoo(hrs_part)
hrs_part_df <- data.frame(date = time(hrs_part), value = coredata(hrs_part))
#hrs_part_df <- data.frame(date = index(hrs_part), value = coredata(hrs_part))   # Error: hrs_part_df is not tsibble
